...
Die Teilnehmerübersicht stellt erhaltene Aktionen und die für einen Rückzug benötigten eigenen Sendungen getrennt dar. **Alle** bleibt in Matches, Interessen und Aktionen der erste Filter. In der Aktionsübersicht folgen die kompakten Richtungsreiter und Typfilter auf dem iPad in derselben horizontalen Auswahlzeile, bleiben fachlich aber unabhängige Filterdimensionen. Ein Richtungswechsel setzt Typ- und Nummernfilter zurück, damit keine unsichtbar weiterwirkende Einschränkung aus der zuvor geöffneten Liste bestehen bleibt. Zurückgezogene Aktionen sind beim Empfänger nicht mehr sichtbar.
