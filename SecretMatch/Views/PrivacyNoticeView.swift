                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        privacyPoint(
                            ...
                            text: "Wenn du freiwillig Feedback gibst, übermittelt die App nur deine beiden Sternbewertungen. Deine Eventnummer und deine Sitzung werden dabei nicht mitgesendet."
                        )
