                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        privacyPoint(
                            ...
                            text: "Während des Events verarbeitet Match&Play deine Eventnummer, eine freiwillige Geschlechtsangabe für die ausgewogene Top-16-Auswahl und passende Aktionsarten, ausgewählte Aktionen, entstandene Matches und technisch notwendige Sitzungsdaten. Das Geschlecht einer Zielnummer wird nicht an die App übertragen. Diese Daten werden ausschließlich für die Durchführung des Spiels verwendet."
                        )
