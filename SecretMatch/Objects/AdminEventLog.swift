...
struct AdminEventLogEntry: Identifiable, Decodable {
    ...
    var title: String {
        ...
        let adminTitles = [
            ...
            "admin_event_announcement_created": "Admin: Event-Mitteilung angelegt",
            "admin_event_announcement_updated": "Admin: Event-Mitteilung geändert",
            "admin_event_announcement_deleted": "Admin: Event-Mitteilung gelöscht",
            ...
            "admin_event_archive_restored": "Admin: Event wiederhergestellt",
            ...
            "wp_admin_event_announcement_created": "WordPress: Event-Mitteilung angelegt",
            "wp_admin_event_announcement_updated": "WordPress: Event-Mitteilung geändert",
            "wp_admin_event_announcement_deleted": "WordPress: Event-Mitteilung gelöscht",
            "wp_admin_event_archive_restored": "WordPress: Event wiederhergestellt",
