...
struct SidebarButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .frame(maxWidth: .infinity, minHeight: veryCompact ? 44 : (compact ? 52 : 66), alignment: .leading)
            .padding(.horizontal, veryCompact ? 12 : (compact ? 15 : 19))
            ...
            .overlay(
                RoundedRectangle(cornerRadius: veryCompact ? 12 : (compact ? 14 : 17), style: .continuous)
