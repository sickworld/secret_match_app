...
- **Offline-Fallback:** Fehlen Profildaten, zeigt die App alle Aktionen und kennzeichnet diesen Zustand. Bei einer bereits erkannten Offline-Verbindung bleibt die Auswahl ebenfalls vollständig verfügbar und weist sichtbar auf den Offline-Modus hin. Unerwartete API-Fehler öffnen die ungefilterte Auswahl nicht mehr still, sondern fordern zur erneuten Bestätigung auf. Match-Wünsche und Hand-Job bleiben immer verfügbar.
