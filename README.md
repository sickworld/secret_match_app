...
Unter **Eventsteuerung → Bildschirmschoner & Sponsoren** verwalten iPhone- und iPad-Adminbereich denselben WordPress-Medienkatalog. Bilder können aus Fotos oder Dateien hochgeladen, aktiviert beziehungsweise pausiert sowie getrennt für Bildschirmschoner und Sponsorleiste freigegeben werden; Begleittext, Anzeigedauer und Reihenfolge bleiben editierbar. Ab Modulversion `2026.09.09.6` werden die vier bisher fest eingebauten Motive und Begleittexte einmalig in die WordPress-Mediathek und diesen Katalog übernommen. Die Teilnehmer-App prüft den Katalog im Vordergrund mindestens einmal pro Minute, speichert Metadaten und Bilder gemeinsam lokal und aktiviert einen neuen Stand erst, wenn sämtliche zugehörigen Bilder vollständig geladen und dekodiert wurden. Ohne Netz bleibt deshalb der letzte vollständige Katalog sichtbar; auf einer frischen Installation dienen die eingebauten Match&Play- und Partnerbilder als Fallback.
...
Diese Funktionen benötigen das WordPress-Modul ab Version `2026.09.09.6`; das Modul muss vor oder zusammen mit diesem App-Build veröffentlicht werden.
